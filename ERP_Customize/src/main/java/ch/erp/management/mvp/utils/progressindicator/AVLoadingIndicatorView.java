...
public class AVLoadingIndicatorView extends View {
	...
	@IntDef(flag = true, value = { BallPulse, BallGridPulse, BallClipRotate,
	...
	// public AVLoadingIndicatorView(Context context, AttributeSet attrs, int
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mIndicatorId = a.getInt(R.styleable.AVLoadingIndicatorView_indicator,
				BallPulse);
		mIndicatorColor = a
				.getColor(R.styleable.AVLoadingIndicatorView_indicator_color,
						Color.WHITE);
		a.recycle();
		mPaint = new Paint();
		...
		if (getVisibility() != v) {
			...
			if (v == GONE || v == INVISIBLE) {
				mIndicatorController
						.setAnimationStatus(BaseIndicatorController.AnimStatus.END);
			} else {
				mIndicatorController
						.setAnimationStatus(BaseIndicatorController.AnimStatus.START);
			}
		}
	}
	...
	protected void onDetachedFromWindow() {
		...
		mIndicatorController
				.setAnimationStatus(BaseIndicatorController.AnimStatus.CANCEL);
	}
