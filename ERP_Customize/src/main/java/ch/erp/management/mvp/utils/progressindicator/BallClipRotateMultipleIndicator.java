...
public class BallClipRotateMultipleIndicator extends BaseIndicatorController {
    ...
    public void draw(Canvas canvas, Paint paint) {
        ...
        for (int i = 0; i < 2; i++) {
            RectF rectF = new RectF(-x + circleSpacing, -y + circleSpacing, x
                    - circleSpacing, y - circleSpacing);
        ...
        for (int i = 0; i < 2; i++) {
            RectF rectF = new RectF(-x / 1.8f + circleSpacing, -y / 1.8f
                    + circleSpacing, x / 1.8f - circleSpacing, y / 1.8f
                    - circleSpacing);
