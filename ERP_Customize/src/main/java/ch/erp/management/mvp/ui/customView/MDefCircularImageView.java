 ...
 * 
 */
public class MDefCircularImageView extends ImageView {
	...
	public MDefCircularImageView(Context context) {
		super(context);

		init();
	}
	public MDefCircularImageView(Context context, AttributeSet attrs) {
